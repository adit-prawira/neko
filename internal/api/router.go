...
import (
	...
	"github.com/adit-prawira/neko/internal/grpc/docs"
...
func buildRoutes(s *Server) http.Handler {
	...
	// gRPC reference docs (single-file HTML, generated by protoc-gen-doc
	// via `make proto` and embedded into the binary).
	mux.HandleFunc("GET /grpc-doc/", func(rw http.ResponseWriter, r *http.Request) {
		rw.Header().Set("Content-Type", "text/html; charset=utf-8")
		_, _ = rw.Write(docs.IndexHTML)
	})
